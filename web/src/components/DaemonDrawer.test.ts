...
describe('daemon diagnostics', () => {
  it('uses explicit version labels and includes safe handoff context', () => {
    const status: DaemonStatus = {
      ...
      instanceId: 'f8ecffdf6d6f', buildId: '9f15670e7324', protocolVersion: '2.0.0', apiVersion: '3.0.0',
    ...
    expect(output).toContain('Protocol Version: 2.0.0')
    expect(output).toContain('API Version: 3.0.0')
