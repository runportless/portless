...
import (
	...
	apiserver "github.com/portless-run/portless/internal/api/server"
...
func Run(ctx context.Context, config Config) error {
	...
	defer instance.RemoveOwn(paths, identity.InstanceID)
