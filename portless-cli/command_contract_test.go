...
func TestEveryPublicCommandHasAuditedBareBehavior(t *testing.T) {
	...
	expected := map[string]string{
		...
		"portless mock route":            showHelp,
		"portless mock route set":        showHelp,
		"portless mock route delete":     showHelp,
		"portless mock preview":          showHelp,
		"portless mock import":           showHelp,
		"portless mock import recording": showHelp,
		"portless mock import openapi":   showHelp,
		...
		"portless env checkout":          showHelp,
		"portless env checkout list":     runAction,
		"portless env checkout set":      showHelp,
		"portless env checkout remove":   showHelp,
...
func TestBareLeafCommandsWithRequiredArgumentsShowHelp(t *testing.T) {
	tests := []struct {
		...
		{name: "environment checkout set", args: []string{"env", "checkout", "set"}, want: "portless env checkout set <source>"},
		{name: "environment checkout remove", args: []string{"env", "checkout", "remove"}, want: "portless env checkout remove <source>"},
