  ...
  return <section className="panel source-checkouts-panel">
    ...
    {checkouts.total > 0 ? <table className="source-table" aria-label="Environment checkouts">
      <thead><tr className="sortable-header-row">
        <SortableTableHeader label="Source" sortKey="source" sort={sort} defaultSort={defaultCheckoutSort} itemCount={orderedRows.length} onSort={(nextSort) => { setSort(nextSort); setPage(0) }} />
        <SortableTableHeader label="Path" sortKey="path" sort={sort} defaultSort={defaultCheckoutSort} itemCount={orderedRows.length} onSort={(nextSort) => { setSort(nextSort); setPage(0) }} />
        <SortableTableHeader label="Created" sortKey="created" sort={sort} defaultSort={defaultCheckoutSort} itemCount={orderedRows.length} onSort={(nextSort) => { setSort(nextSort); setPage(0) }} />
