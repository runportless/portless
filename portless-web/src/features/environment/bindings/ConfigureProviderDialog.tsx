...
import type { ComponentBinding, Environment, MockProfile, Operation, Project, ProviderKind, RemoteClassification, WritePolicy } from '../../../types'
...
export function ConfigureProviderDialog({ environment, project, initialService, mockProfiles, onChanged, onClose }: {
  ...
  const [mockProfile, setMockProfile] = useState(initialBinding?.mock?.profile || mockProfiles.find((profile) => profile.service.toLowerCase() === initialServiceName.toLowerCase())?.name || '')
